...
from scripts.mantra_move_client import *
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            if rad_deg_flag is 0:
                ...
                if curr_positions[0] < 0:
                    if float(curr_positions[0] / pi * 180.0) <= -100:
                        self.window.label_1.setText("Joint1 (%.2f deg )" % float(curr_positions[0] / pi * 180.0))
                    else:
                        self.window.label_1.setText("Joint1 (%.3f deg )" % float(curr_positions[0] / pi * 180.0))
                else:
                    if curr_positions[0] >= 100:
                        self.window.label_1.setText("Joint1 ( %.2f deg )" % float(curr_positions[0] / pi * 180.0))
                    else:
                        self.window.label_1.setText("Joint1 ( %.3f deg )" % float(curr_positions[0] / pi * 180.0))
                if curr_positions[1] < 0:
                    if float(curr_positions[1] / pi * 180.0) <= -100:
                        self.window.label_2.setText("Joint2 (%.2f deg )" % float(curr_positions[1] / pi * 180.0))
                    else:
                    ...
                    if float(curr_positions[1] / pi * 180.0) >= 100:
                        ...
                        self.window.label_2.setText("Joint2 ( %.3f deg )" % float(curr_positions[1] / pi * 180.0))
                if curr_positions[2] < 0:
                    if float(curr_positions[2] / pi * 180.0) <= -100:
                        self.window.label_3.setText("Joint3 (%.2f deg )" % float(curr_positions[2] / pi * 180.0))
                    else:
                    ...
                    if float(curr_positions[2] / pi * 180.0) >= 100:
                        ...
                        self.window.label_3.setText("Joint3 ( %.3f deg )" % float(curr_positions[2] / pi * 180.0))
                if curr_positions[3] < 0:
                    if float(curr_positions[3] / pi * 180.0) <= -100:
                        self.window.label_4.setText("Joint4 (%.2f deg )" % float(curr_positions[3] / pi * 180.0))
                    else:
                    ...
                    if float(curr_positions[3] / pi * 180.0) >= 100:
                        ...
                        self.window.label_4.setText("Joint4 ( %.3f deg )" % float(curr_positions[3] / pi * 180.0))
                if curr_positions[4] < 0:
                    if float(curr_positions[4] / pi * 180.0) <= -100:
                        self.window.label_5.setText("Joint5 (%.3f deg )" % float(curr_positions[4] / pi * 180.0))
                    else:
                        self.window.label_5.setText("Joint5 (%.2f deg )" % float(curr_positions[4] / pi * 180.0))
                else:
                    if float(curr_positions[3] / pi * 180.0) >= 100:
                        self.window.label_5.setText("Joint5 ( %.2f deg )" % float(curr_positions[4] / pi * 180.0))
                    else:
                        self.window.label_5.setText("Joint5 ( %.3f deg )" % float(curr_positions[4] / pi * 180.0))
                if curr_positions[5] < 0:
                    if float(curr_positions[5] / pi * 180.0) <= -100:
                        self.window.label_6.setText("Joint6 (%.2f deg )" % float(curr_positions[5] / pi * 180.0))
                    else:
                    ...
                    if float(curr_positions[5] / pi * 180.0) >= 100:
                        ...
                        self.window.label_6.setText("Joint6 ( %.3f deg )" % float(curr_positions[5] / pi * 180.0))
                if curr_positions[6] < 0:
                    if float(curr_positions[6] / pi * 180.0) <= -100:
                        self.window.label_7.setText("Joint7 (%.2f deg )" % float(curr_positions[6] / pi * 180.0))
                    else:
...
class MyWindow(QMainWindow, Ui_Form):
    ...
    def rad_deg(self):
        ...
        if rad_deg_flag is 0:
            rad_deg_flag = 1
            self.radDegButton.setText("deg")
        else:
            rad_deg_flag = 0
            self.radDegButton.setText("rad")
